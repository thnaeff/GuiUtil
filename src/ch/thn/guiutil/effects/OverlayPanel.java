...
public class OverlayPanel extends JPanel {
	 ...
	 * Positions the layered pane as "high" as possible (in front of all other
	 * layered panes), with a value of 999.
	 * 
	 * 
	 * @param layeredPane
	 * @param visible
	 ...
	 * Setting the color to <code>null</code> creates a completely transparent
	 * overlay panel.
	 * 
	 * @param color
	 */
	...
	/**
	 * If this is set to <code>true</code>, events like mouse or key events
	 * are passed through to the underlying components and are not consumed by the
	 * overlay panel. This means that underlying components can be controlled through
	 * this overlay panel.
	 * If set to <code>false</code>, underlying components can not be controlled.
	 * 
	...
	/**
	 * If eventPassThrough is set to <code>true</code>, events like mouse or key events
	 * are passed through to the underlying components and are not consumed by the
	 * overlay panel. This means that underlying components can be controlled through
	 * this overlay panel.
	 * If eventPassThrough is set to <code>false</code>, underlying components
	 * can not be controlled.
	 * 
	 * @param eventPassThrough
	 * @param fullPassThrough If set to <code>true</code>, all component events on the
	 * overlay panel are ignored and passed to the underlying components. This means
	 * that any components on the overlay panel can not be selected or controlled, but
	 * it also means that for example the mouse cursor changes according to the underlying
	 * components. Only available if eventPassThrough=<code>true</code>
	 */
