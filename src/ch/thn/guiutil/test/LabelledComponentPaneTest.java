...
public class LabelledComponentPaneTest extends JPanel {
	...
	public LabelledComponentPaneTest() {
		...
		lPanel.addLabelComponent(1, new JLabel("Long1:"), new JLabel("abcdefg ddddddddddddddddddddddddddddddddddddddddddddd asd fasd fasdf asdf asdfasd"), true);
		lPanel.addLabelComponent(1, new JLabel("Long2:"), new JLabel("abcdefg dddddddddddddddddddddddddddd asd fasd fasdf asdf asdfasd"));
