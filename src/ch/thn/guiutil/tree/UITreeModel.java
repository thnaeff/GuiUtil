...
/**
 * A tree model which holds the data for a {@link JTree}. The {@link JTree} is updated
 * automatically when the data changes.<br />
 ...
 *
 */
public class UITreeModel<N extends ListTreeNodeInterface<?, N>> implements TreeModel, TreeNodeListener<N> {
	...
	private void fireNodeRemoved(N source, N parent, int sourceNodeIndex) {
		...
		final TreeModelEvent e = new TreeModelEvent(source, getTreePath(parent, false), childIndices, children);
	...
	public void nodeRemoved(TreeNodeEvent<N> e) {
		System.out.println(e.getSource() + " -> removed: " + e.getNode());
		N node = e.getNode();
	...
	public void nodeAdded(TreeNodeEvent<N> e) {
		System.out.println(e.getSource() + " -> added: " + e.getNode());
		N node = e.getNode();
	...
	public void nodeReplaced(TreeNodeEvent<N> e) {
		System.out.println(e.getSource() + " -> replaced: " + e.getOldNode().toString() + "=>" + e.getNode());
	...
	public void nodeValueChanged(TreeNodeEvent<N> e) {
		System.out.println(e.getSource() + " -> value changed " + e.getNode());
		N node = e.getNode();
