...
public class SwitcherComponent {
	...
	/**
	 * The PanelSwitcher component which contains the panel and the corresponding
	 * button (with text and/or icon) to switch to the panel
	 * 
	...
	/**
	 * The panel with the button. The panel is used to add a invisible border
	 * to set the space between buttons.
	 * 
