...
/**
 * This is a {@link JLabel} which does various clipping of its text (replacing 
 * exceeding characters with "...").<br>
 * <br>
 * <b>Info:</b> The tool-tip text of this {@link JLabel} is used to display the 
 * full text when the text had to be clipped. Thus, {@link #setToolTipText(String)} 
 * on this {@link ClippingLabel} will be overwritten internally whenever the 
 * clipping is updated.
 * 
 * 
...
public class ClippingLabel extends JLabel implements AncestorListener, ComponentListener {
	...
	public void setClippingMode(int clippingMode) {
		if (clippingMode < 0 || clippingMode > 2) {
			throw new GuiUtilError("Unknown clipping mode " + clippingMode);
		}
	 ...
	 * Hint: the getText-method needs to return the clipped string since that is 
	 * the string which is displayed in the label.
	 */
