...
/**
 * This class gives the possibility to define an area within the component which 
 * informs the added {@link ActionAreaListener}s when the mouse has entered/exited 
 * that area.<br>
 * <br>
 * The {@link MouseCursorArea} and {@link ToolTipArea} classes are built on the 
 * base of this class.
 * 
 * 
