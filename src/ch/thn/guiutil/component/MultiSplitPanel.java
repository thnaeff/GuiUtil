...
/**
 * A panel which separates each added component {@link #addSplitComponent(Component)}
 * with a split pane. The orientation can be configured horizontal (left/right) and
 * vertical (up/down).
 * 
 * 
 *
...
public class MultiSplitPanel extends JPanel {
	...
	public Component add(Component comp) {
		throw new UnsupportedOperationException("Adding components only allowed through addSplitComponent(Component)");
	}
