...
/**
 * Draws images in the given component. The specialty of
...
public class BorderImage implements AncestorListener, PropertyChangeListener, ComponentListener {
	...
	private void update() {
		...
		componentWidth = (int)component.getSize().getWidth()
				- thickness[ComponentPadding.EAST] - thickness[ComponentPadding.WEST];
		componentHeight = (int)component.getSize().getHeight()
				- thickness[ComponentPadding.NORTH] - thickness[ComponentPadding.SOUTH];
