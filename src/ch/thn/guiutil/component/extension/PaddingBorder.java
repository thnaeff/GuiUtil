...
/**
 * An implementation of a {@link Border}. Uses a compound border to create a padding
 * around a component. The border set for the given component is preserved and used
 * as inner border of the compound border.
 * 
 * 
	...
	protected void showOuterBorder(boolean show) {
		...
		if (component != null && component.getParent() != null) {
			outer = BorderFactory.createMatteBorder(
					thickness[ComponentPadding.NORTH],
					thickness[ComponentPadding.WEST],
					thickness[ComponentPadding.SOUTH],
					thickness[ComponentPadding.EAST],
